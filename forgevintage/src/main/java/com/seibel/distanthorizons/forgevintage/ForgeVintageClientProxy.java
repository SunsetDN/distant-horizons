...
public class ForgeVintageClientProxy implements AbstractModInitializer.IEventProxy
{
	private static final IMinecraftClientWrapper MC = SingletonInjector.INSTANCE.get(IMinecraftClientWrapper.class);
	private static final ForgeVintagePluginPacketSender PACKET_SENDER = (ForgeVintagePluginPacketSender) SingletonInjector.INSTANCE.get(IPluginPacketSender.class);
